...
class TinyYOLOv3_onecls(object):
    ...
    def __init__(self,
                 input_size=416,
                 config_file='/content/drive/MyDrive/An and Duy ML Report/Testing code - Tracking/Models/yolov3-tiny-onecls.cfg',
                 weight_file='/content/drive/MyDrive/An and Duy ML Report/Testing code - Tracking/Models/best-model.pth',
                 nms=0.2,
                 conf_thres=0.45,
                 device='cuda'):
